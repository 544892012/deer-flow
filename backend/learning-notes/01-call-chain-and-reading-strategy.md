...
之前已经生成了 7 份学习文档（在 `docs/learning/` 目录）：

| 文件                             | 内容                                  |
| ------------------------------ | ----------------------------------- |
| `01-architecture-overview.md`  | 整体架构、技术栈、服务端口                       |
| `02-agent-and-middleware.md`   | Agent 编排模型、ThreadState、Middleware 链 |
| `03-sub-agents.md`             | 子 Agent 协作、调用序列、并发控制                |
| `04-sandbox-and-filesystem.md` | 沙箱架构、虚拟路径、安全机制                      |
| `05-context-management.md`     | 5 层上下文管理系统                          |
| `06-multi-agent-reference.md`  | 多 Agent 设计模式参考                      |
| `07-request-lifecycle.md`      | 完整请求链路（HTTP → ReAct 循环）             |
